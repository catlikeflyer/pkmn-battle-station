...
with col2:
    ...
    pokemon2_name = st.selectbox("Select Pokemon 2", pokemon_names, index=default_idx, key="p2")
        ...
        with st.spinner("Loading Pokemon data..."):
            try:
                ...
                with col1:
                    ...
                    st.write(f"**Type:** {pokemon1.type1.title()}" + 
                ...
                with col2:
                    ...
                    st.write(f"**Type:** {pokemon2.type1.title()}" + 
                ...
                if winner:
                    ...
                    st.metric("Final HP", f"{winner.current_hp}/{winner.max_hp}", 
...
st.markdown("---")
st.info("💡 **Tip:** Battles use real Pokemon mechanics including type effectiveness, STAB, and critical hits!")
